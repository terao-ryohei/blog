    ...
    return c.render(
      <div>
        <div class={"flex gap-8 max-md:flex-col"}>
          <div
            class={
              "bg-gray-200 dark:bg-gray-700 py-8 px-4 sm:px-14 sm:rounded-md w-[75%] max-md:w-full"
            }
          >
          ...
          <div class={"flex flex-col col-span-2 gap-2 flex-grow"}>
            ...
            >
              ...
              >
                公開日：
                <span class={"text-right flex-grow"}>{date}</span>
              </time>
              <time
                class={
                  "flex justify-between flex-wrap basis-4 text-gray-600 dark:text-gray-300 text-base"
              ...
              >
                最終更新日：
                <span class={"text-right flex-grow"}>{update}</span>
              </time>
